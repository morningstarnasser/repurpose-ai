...
export default function NewRepurposePage() {
  ...
  const showExtractStep = method !== "text" && !extracted;
        ...
        <form onSubmit={handleGenerate}>
          ...
          {method === "upload" && !extracted && (
            <div className="mb-6">
              ...
              <div
                ...
                className={`brutal-card p-8 text-center cursor-pointer transition-colors ${
                  file ? "bg-lime/20" : "bg-white hover:bg-primary/10"
                }`}
              >
                <input
                  ref={fileRef}
                ...
                {file ? (
                  <>
                    <div className="text-3xl mb-2">
                      {file.type.startsWith("audio/") ? "🎙️" : file.type.startsWith("video/") ? "🎬" : "📄"}
                    </div>
                  ...
                  <>
                    ...
                    <p className="text-xs text-dark/40">
                      {Object.values(acceptedFiles).join(" · ")}
                    </p>
              ...
              {file && (
                <div className="flex gap-3 mt-3">
                  <button
                    ...
                    onClick={handleExtract}
                    disabled={extracting}
                    className={`brutal-btn flex-1 py-3 ${extracting ? "bg-dark/50 text-white" : "bg-accent"}`}
                  >
                    {extracting ? (
                  ...
                  <button
                    ...
                    className="brutal-btn px-4 py-3 bg-secondary/20 text-secondary"
                  >
                    Remove
                  </button>
                </div>
          ...
          {extracted && method !== "text" && (
            <div className="flex items-center gap-2 mb-3">
              ...
              <button
                type="button"
                onClick={() => { setExtracted(false); setContent(""); }}
                className="text-xs font-bold text-dark/40 hover:text-secondary"
              >
                Change source
              </button>
            </div>
