          ...
          {data.outputs.map((output) => (
            <div key={output.platform} className="brutal-card p-6 bg-white flex flex-col">
              ...
              {editing === output.platform ? (
                <div className="flex-1 mb-4">
                  ...
                  <div className="flex gap-2 mt-2">
                    <button onClick={() => handleSaveEdit(output.platform)} className="brutal-btn px-4 py-1.5 text-xs bg-lime">
                      Save
                    </button>
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() => { setEditing(output.platform); setEditContent(output.content); }}
                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-0 top-full mt-1 hidden group-hover:flex flex-col gap-1 z-10 brutal-border bg-white p-2 shadow-[4px_4px_0_#000]">
                    {TONES.map((t) => (
                      <button
                        key={t}
                        onClick={(e) => { e.stopPropagation(); handleRegenerate(output.platform, t); }}
