...
const steps = [
  {
    ...
    title: "Upload",
    description:
      "Paste text, import a blog URL or YouTube video, upload audio/video for AI transcription, or drop a PDF. All formats supported.",
    color: "bg-primary",
    icon: ">",
  },
  {
    ...
    title: "AI Transform",
    description:
      "Our AI analyzes your content, matches your voice style, and generates optimized versions with platform-specific images for every channel.",
    color: "bg-secondary",
    icon: "!",
  },
  {
    ...
    title: "Share & Export",
    description:
      "Share directly to any platform with one click, download AI-generated images, or export everything as CSV. Ready to post in seconds.",
    color: "bg-accent",
    icon: "*",
  },
];
